 ...
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    ...
    <x:WorksheetSource HRef=3D"file9796_files/sheet001.htm"/>
   </x:ExcelWorksheet>
  </x:ExcelWorksheets>
  <x:Stylesheet HRef=3D"file9796_files/stylesheet.css"/>
...
if (window.name!=3D"frSheet")
 window.location.replace("../file9796.htm");
else
 fnUpdateTabs();
//-->
</script>
